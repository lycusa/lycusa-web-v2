            ...
            <div className="flex items-end gap-3 max-w-4xl mx-auto">
                ...
                <div className="flex items-center gap-1 mb-1.5">
                    <button
                        ...
                        className="p-2 text-gray-400 hover:text-brand-600 hover:bg-brand-50 rounded-full transition-all disabled:opacity-50"
                ...
                {/* Input Area */}
                <div className="flex-1 relative bg-gray-50 rounded-2xl border border-gray-200 focus-within:border-brand-500 focus-within:ring-1 focus-within:ring-brand-500 transition-all">
                    <textarea
                        ref={textareaRef}
                        value={message}
                ...
                <button
                    ...
                    className={`
                        ...
                        ${(!message.trim() && !mediaFile) || disabled || sending
                            ...
                            : "bg-brand-600 text-white hover:bg-brand-700 hover:shadow-md hover:scale-105 active:scale-95"
                        }
                    `}
                >
                    {sending ? (
